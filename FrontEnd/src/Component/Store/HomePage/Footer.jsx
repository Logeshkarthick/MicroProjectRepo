                    ...
                    <div class="container overflow-hidden">
                        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                            <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                                <div class="widget">
                                    <a href="#!">
                                        <img src={Logo} alt="BootstrapBrain Logo" width="175" height="57" style={{ mixBlendMode: 'Multiply' }} />
                                    </a>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                                <div class="widget">
                                    ...
                                    <address class="mb-4">
                                        ...
                                        Maruthi Infotech Center 11/1,12/1 B wing 1st
                                        Floor Amarjyothi layout Intermediate ring
                                        road Domlur, B.B.M.P East, Karnataka-560071
                                        Bangalore, Karnataka - 560071

                                    </address>
                                    <p class="mb-1">
                                        <a class="link-secondary text-decoration-none" href="tel:+15057922430">Call: 1800-4190-786</a>
                                    </p>
                                    <p class="mb-0">
                                        <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">talktous@meatzo.com</a>
                                    </p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <div class="row gy-4 gy-md-0">
                            <div class="col-xs-12 col-md-7 order-1 order-md-0">
                                ...
                                <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
                                    Built by <a href="#" class="link-secondary text-decoration-none">Ayrus</a> with React and Spring Boot <span class="text-primary"></span>
                                </div>
                            </div>
